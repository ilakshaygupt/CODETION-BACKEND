...
urlpatterns = [
    ...
    path('quiz/question/<int:question_id>/submission/<int:id>/', views.SubmissionCreateGet.as_view({'post': 'create','get': 'list','get':'retrieve'}), name='choice-list'),
    path('quiz/score/', views.ScoreViewSet.as_view(), name='score-list'),
]
